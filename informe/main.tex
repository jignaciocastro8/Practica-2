...
\subsection{Replicación IPSA}
   ...
   Por otra parte, notar que los \comillas{pesos} $w_i$ no suman $1$, la Fórmula \ref{eq:ipsa1} es una adaptación de la fórmula real del IPSA usando la información disponible para el estudio, se mostrará una comparación cambiando los pesos $w_i$.
   	\begin{remark}
